...
int plat_core_pos_by_mpidr(u_register_t mpidr)
{
	...
	{
		WARN("plat_core_pos_by_mpidr: mpidr - 0x%lx, MPIDR_CUSTER_MASK - 0x%llx, mpidr & MPIDR_CLUSTER_MASK = 0x%llx\n",
	...
	{
		WARN("plat_core_pos_by_mpidr: >= PLATFORM_CORE_COUNT : mpidr - 0x%lx, MPIDR_CPU_MASK - 0x%llx, mpidr & MPIDR_CPU_MASK = 0x%llx\n",
