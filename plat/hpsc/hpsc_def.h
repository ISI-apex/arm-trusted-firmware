...
#define HPSC_CSU_IDCODE_XILINX_ID_SHIFT	0
#define HPSC_CSU_IDCODE_XILINX_ID_MASK	(0xFFF << HPSC_CSU_IDCODE_XILINX_ID_SHIFT)
#define HPSC_CSU_IDCODE_XILINX_ID		0x093
