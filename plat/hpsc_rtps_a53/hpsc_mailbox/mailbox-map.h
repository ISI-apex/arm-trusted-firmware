...
#define MBOX_HPPS_TRCH__HPPS_ATF_TRCH 28
#define MBOX_HPPS_TRCH__TRCH_ATF_HPPS 29
...
#define MBOX_HPPS_TRCH__HPPS_RCV_ATF_INT 4
#define MBOX_HPPS_TRCH__HPPS_ACK_ATF_INT 5
